    ...
    <div className="bg-gray-900 border border-gray-800 rounded-xl overflow-hidden">
      ...
      >
        <div className="flex items-center gap-2">
          <span className="text-xs font-bold text-gray-500 uppercase tracking-widest">Front Matter</span>
          {enabledCount > 0 && (
      ...
      {open && (
        <div className="border-t border-gray-800 px-5 py-4 space-y-2">
          {loading ? (
            ...
            <>
              <p className="text-xs text-gray-600 pb-1">Toggle sections on to include them. Click Edit to add content.</p>
