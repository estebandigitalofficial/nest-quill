  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <h2 className="text-sm font-semibold text-gray-400 uppercase tracking-widest">Chapters</h2>
        <button
      ...
      {book.chapters.length === 0 && !adding && (
        <div className="bg-gray-900 border border-dashed border-gray-700 rounded-xl px-6 py-10 text-center space-y-2">
          <p className="text-gray-500 text-sm">No chapters yet. Add your first chapter to start.</p>
          <button
            onClick={() => setAdding(true)}
            ...
            >
              <div className="px-5 py-4 flex items-start justify-between gap-4">
                <div className="min-w-0 flex-1">
                  ...
                  <p className="text-xs text-gray-500 mt-1 line-clamp-2">{chapter.brief}</p>
                ...
                <div className="flex items-center gap-2 shrink-0">
                  ...
                  <button
                    ...
                    className="text-xs text-gray-600 hover:text-red-400 transition-colors p-1.5"
                  >
                    ✕
                  </button>
                </div>
          ...
          <div className="bg-gray-900 border border-brand-700 rounded-xl px-5 py-4 space-y-3">
            ...
            <div className="flex gap-2">
              <button
                ...
                className="flex-1 text-sm text-gray-500 hover:text-gray-300 py-2 rounded-lg border border-gray-700 transition-colors"
              >
                Cancel
              </button>
              <button
...
const inputClass = 'w-full bg-gray-800 border border-gray-700 rounded-lg px-3 py-2.5 text-sm text-white placeholder:text-gray-600 focus:outline-none focus:ring-2 focus:ring-brand-500 focus:border-transparent'
