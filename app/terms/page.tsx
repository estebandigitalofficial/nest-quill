    ...
    <div className="h-dvh bg-parchment flex flex-col">
      ...
      <main className="max-w-3xl mx-auto px-6 py-14 space-y-10 w-full">
        ...
        <Section title="Adult Content">
          <p>
            Nest &amp; Quill offers story creation for adult readers (18+). By selecting the adult option,
            you confirm that you are at least 18 years old.
          </p>
          <p>
            Adult stories may contain more complex themes, mature narratives, and content that differs in tone
            from our children&apos;s stories. Adult content is generated using a separate AI configuration
            designed for mature audiences.
          </p>
          <p>
            Adult stories are not suitable for children. Users are responsible for ensuring that adult content
            is not shared with or accessible to minors.
          </p>
          <p>
            We reserve the right to moderate, restrict, or remove adult content that violates our acceptable use policy
            or applicable laws.
          </p>
        </Section>
