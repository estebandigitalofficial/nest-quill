...
export default function ConceptExplainer({ assignmentId, initialTopic, initialGrade, initialImage }: Props) {
    ...
    <div className="space-y-4">
      ...
      {result && (
        <div className="space-y-3">
          ...
          <button onClick={() => { setResult(null); setTopic(initialTopic ?? ''); setGrade(initialGrade ?? null); clearImage(); submittedRef.current = false; setXpEarned(null) }}
